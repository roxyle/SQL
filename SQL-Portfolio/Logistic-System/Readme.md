...
- **fornitori**: Informazioni fornitori con rating affidabilità
  ![tabella fornitori](fornitori.png)
- **categorie_prodotti**: Categorie merceologiche
  ![tabella categorie](categorie.png)
- **magazzini**: Ubicazioni fisiche con capacità
  ![tabella magazzini](magazzini.png)
- **prodotti**: Catalogo prodotti con prezzi e scorte minime
  ![tabella prodotti](prodotti.png)
- **inventario**: Giacenze attuali per prodotto/magazzino
  ![tabella inventario](inventario.png)
- **ordini_rifornimento**: Ordini ai fornitori con date e stati
  ![tabella ordini](ordini.png)
- **dettagli_ordini_rifornimento**: Prodotti ordinati in ogni rifornimento
  ![tabella dettaglio ordini](dettaglio.png)
- **movimenti_magazzino**: Storico entrate/uscite prodotti
